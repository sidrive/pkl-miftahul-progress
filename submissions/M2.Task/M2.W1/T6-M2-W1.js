...
// getSummary: function() {
//     return ("Halo, saya " + this.nama + ` , saya seorang ${this.peran}. Saat ini saya telah menyelesaikan ${this.tugasSelesai} tugas. Saya tinggal di ${this.alamat} dan bekerja di divisi this.divisi.`);
// }
// };
...
const sisa = hitungSisaTugas(10, 1);
