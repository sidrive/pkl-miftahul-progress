...
- Dasar debugging — ringkas (dipecah jadi 3 sub-task):
  ...
  - [ ] <!-- id: M2.W5.T1.2 --> Praktik `debugger;`/breakpoint di DevTools (Sources tab) DAN strategi **bisection** (taruh `console.log` di TENGAH kode dulu untuk mempersempit lokasi bug, bukan baca ulang semua baris dari awal) — praktikkan keduanya di 1 fungsi dari project to-do list Minggu 4
  - [ ] <!-- id: M2.W5.T1.3 --> **[Wajib Refleksi]** Jelaskan dengan kata sendiri: kenapa breakpoint/bisection lebih cepat menemukan bug dibanding baca ulang semua kode dari awal — kaitkan ke pengalaman nyata minggu-minggu sebelumnya waktu kamu butuh waktu lama cari bug
